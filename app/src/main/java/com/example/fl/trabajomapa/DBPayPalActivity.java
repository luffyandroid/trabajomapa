...
public class DBPayPalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dbpay_pal);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PAYPAL_REQUEST_CODE){
            ...
            String uid = getIntent().getStringExtra("EXTRA_UIDDA");
    ...
    private void processPayment() {
        ...
        PayPalPayment payPalPayment = new PayPalPayment(new BigDecimal(String.valueOf(amount)), "EUR",
                ...
                //CONCEPTO DEL PAGO
                "Renovacion de oferta de empleo en GeoWork", PayPalPayment.PAYMENT_INTENT_SALE);
