...
public class CCPublicadoActivity extends AppCompatActivity {
    ...
    TextView tvuidcc, tvmailempresacc, tvnombreempresaCC,tvnombrepuestoCC, tvdetallespuestoCC, tvsalariopuestoCC, tvtipopuestoCC, tvtelefonopuestoCC,
     tvcorreopuestoCC, tvdireccionpuestoCC, tvlatitudpuestoCC, tvlongitudpuestoCC;
