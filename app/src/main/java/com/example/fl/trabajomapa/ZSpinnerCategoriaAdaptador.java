...
public class ZSpinnerCategoriaAdaptador extends ArrayAdapter<ZSpinnerCategoria>
{
    private Context context;

    List<ZSpinnerCategoria> datos = null;

    public ZSpinnerCategoriaAdaptador(Context context, List<ZSpinnerCategoria> datos)
    {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent)
    {
        ...
        ZSpinnerCategoria redSocial = datos.get(position);
